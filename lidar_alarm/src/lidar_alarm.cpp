...
float ping_dist_in_front_7=3.0;
float ping_dist_in_front_8=3.0;
float ping_dist_in_front_6=3.0;
...
void laserCallback(const sensor_msgs::LaserScan& laser_scan) {
    if (ping_index_<0)  {
        ...
        // but this will do for simple illustratio
 ...
 /*  ping_dist_in_front_2 = laser_scan.ranges[ping_index_2];    
   ...
   ping_dist_in_front_8 = laser_scan.ranges[ping_index_8];
   ping_dist_in_front_7 = laser_scan.ranges[ping_index_7];
  */
    ROS_INFO("ping dist in front = %f",ping_dist_in_front_);

   if (ping_dist_in_front_<= MIN_SAFE_DISTANCE || ping_dist_in_front_2<MIN_SAFE_DISTANCE || ping_dist_in_front_3<MIN_SAFE_DISTANCE || ping_dist_in_front_4<MIN_SAFE_DISTANCE || ping_dist_in_front_5<MIN_SAFE_DISTANCE || ping_dist_in_front_6<MIN_SAFE_DISTANCE || ping_dist_in_front_7<MIN_SAFE_DISTANCE || ping_dist_in_front_8<MIN_SAFE_DISTANCE) {
